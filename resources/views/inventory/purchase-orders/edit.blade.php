...
@section('content')
    @include('layouts.partials.page-title', ['subtitle' => 'Inventory', 'title' => 'Edit Purchase Order'])

    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('inventory.purchase-orders.update', $purchaseOrder->id) }}" method="POST" id="purchase-order-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary">
                                <i class="ti ti-check me-1"></i> Update Purchase Order
                            </button>
