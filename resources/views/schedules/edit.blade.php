                ...
                <form action="{{ route('schedules.update', $schedule->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="user_id" class="form-select" required>
                                ...
                                <option value="{{ $staff->id }}" {{ old('user_id', $schedule->user_id) == $staff->id ? 'selected' : '' }}>{{ $staff->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="grace_period_minutes" class="form-control" value="{{ old('grace_period_minutes', $schedule->grace_period_minutes ?? 15) }}" min="0" max="60">
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input type="checkbox" name="is_working_day" value="1" class="form-check-input" id="is_working_day" {{ old('is_working_day', $schedule->is_working_day) ? 'checked' : '' }}>
