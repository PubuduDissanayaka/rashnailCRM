...
@section('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Date time pickers (using flatpickr if available)
            // We'll rely on the global flatpickr initialization from the theme
                        ...
                        <div class="tab-content" id="couponTabsContent">
                            ...
                            <div class="tab-pane fade show active" id="basic" role="tabpanel">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="batch_id" name="batch_id">
                                                ...
                                                <option value="{{ $batch->id }}" {{ old('batch_id') == $batch->id ? 'selected' : '' }}>{{ $batch->name }} ({{ $batch->coupons_count ?? 0 }} coupons)</option>
                                                @endforeach
                                            </select>
                                            @error('batch_id')
                                                <span class="text-danger"><small>{{ $message }}</small></span>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control flatpickr" type="text" id="start_date" name="start_date" value="{{ old('start_date') }}" required data-date-format="Y-m-d" data-alt-format="F j, Y" data-default-date="today">
                                            @error('start_date')
                                                <span class="text-danger"><small>{{ $message }}</small></span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control flatpickr" type="text" id="end_date" name="end_date" value="{{ old('end_date') }}" data-date-format="Y-m-d" data-alt-format="F j, Y">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="timezone" name="timezone" required>
                                        <option value="Asia/Colombo" {{ old('timezone', 'Asia/Colombo') == 'Asia/Colombo' ? 'selected' : '' }}>Asia/Colombo (UTC+5:30)</option>
                            ...
                            <div class="tab-pane fade" id="discount" role="tabpanel">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="type" name="type" required>
                                        ...
                                        <option value="tiered" {{ old('type') == 'tiered' ? 'selected' : '' }}>Tiered Discount</option>
                                    </select>
                                    @error('type')
                                        <span class="text-danger"><small>{{ $message }}</small></span>
                                    @enderror
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3" id="discount-percentage-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" id="discount_percentage" name="discount_percentage" value="{{ old('discount_percentage') }}" step="0.01" min="0" max="100" placeholder="e.g., 10">
                                        ...
                                        <div class="mb-3" id="discount-value-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="discount_value" name="discount_value" value="{{ old('discount_value') }}" step="0.01" min="0" placeholder="e.g., 500">
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3" id="max-discount-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">{{ $currencySymbol }}</span>
                                                <input type="number" class="form-control" id="max_discount_amount" name="max_discount_amount" value="{{ old('max_discount_amount') }}" step="0.01" min="0" placeholder="e.g., 1000">
                                            </div>
                                        ...
                                        <div class="mb-3" id="min-purchase-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">{{ $currencySymbol }}</span>
                                                <input type="number" class="form-control" id="minimum_purchase_amount" name="minimum_purchase_amount" value="{{ old('minimum_purchase_amount') }}" step="0.01" min="0" placeholder="e.g., 1000">
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="total_usage_limit" name="total_usage_limit" value="{{ old('total_usage_limit') }}" min="1" placeholder="e.g., 100">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="per_customer_limit" name="per_customer_limit" value="{{ old('per_customer_limit') }}" min="1" placeholder="e.g., 1">
                            ...
                            <div class="tab-pane fade" id="restrictions" role="tabpanel">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="customer_eligibility_type" name="customer_eligibility_type" required>
                                        <option value="all" {{ old('customer_eligibility_type') == 'all' ? 'selected' : '' }}>All Customers</option>
                                        <option value="new" {{ old('customer_eligibility_type') == 'new' ? 'selected' : '' }}>New Customers Only</option>
                                        <option value="existing" {{ old('customer_eligibility_type') == 'existing' ? 'selected' : '' }}>Existing Customers Only</option>
                                        <option value="groups" {{ old('customer_eligibility_type') == 'groups' ? 'selected' : '' }}>Specific Customer Groups</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="location_restriction_type" name="location_restriction_type" required>
                                        <option value="all" {{ old('location_restriction_type') == 'all' ? 'selected' : '' }}>All Locations</option>
                                        <option value="specific" {{ old('location_restriction_type') == 'specific' ? 'selected' : '' }}>Specific Locations</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="product_restriction_type" name="product_restriction_type" required>
                                        <option value="all" {{ old('product_restriction_type') == 'all' ? 'selected' : '' }}>All Products/Services</option>
                                        <option value="specific" {{ old('product_restriction_type') == 'specific' ? 'selected' : '' }}>Specific Products/Services</option>
                                        <option value="categories" {{ old('product_restriction_type') == 'categories' ? 'selected' : '' }}>Specific Categories</option>
                                    </select>
                                ...
                                <div class="mb-3 conditional-field" id="product-specific-group">
                                    ...
                                    <select class="form-select" name="products[]" id="products" data-choices multiple>
                                        ...
                                        <option value="service_{{ $service->id }}" {{ in_array('service_' . $service->id, old('products', [])) ? 'selected' : '' }}>{{ $service->name }} (Service)</option>
                                        @endforeach
                                        @foreach($servicePackages as $package)
                                        <option value="package_{{ $package->id }}" {{ in_array('package_' . $package->id, old('products', [])) ? 'selected' : '' }}>{{ $package->name }} (Package)</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="tab-pane fade" id="advanced" role="tabpanel">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="metadata" name="metadata" rows="6" placeholder='{"notes": "", "created_by": ""}'>{{ old('metadata') }}</textarea>
