                    ...
                    <div class="card-body min-vh-100 d-flex flex-column justify-content-center">
                        <div class="auth-brand mb-0 text-center">
                            <a class="logo-dark" href="{{ route('second', ['dashboard', 'index']) }}">
                                <img alt="dark logo" height="28" src="{{ $appLogoDarkUrl }}" />
                            </a>
                            <a class="logo-light" href="{{ route('second', ['dashboard', 'index']) }}">
                                <img alt="logo" height="28" src="{{ $appLogoUrl }}" />
                            </a>
                        </div>
                        <div class="mt-auto">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="app-search">
                                        <input class="form-control" id="userEmail" name="email" placeholder="you@example.com"
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="userPassword">Password <span
                                            class="text-danger">*</span></label>
                                    <div class="app-search">
                                        <input class="form-control" id="userPassword" name="password" placeholder="••••••••"
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input form-check-input-light fs-14"
                                            id="rememberMe" type="checkbox" name="remember" />
                        ...
                        <p class="text-center text-muted mt-auto mb-0">
                            ©
                            Developed — by <span class="fw-semibold">DevTenent</span>
                        </p>
                    </div>
                </div>
