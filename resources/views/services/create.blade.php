...
@section('content')
    @include('layouts.partials.page-title', ['title' => 'Create Service'])
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="number" id="duration" name="duration" value="{{ old('duration') }}" min="1" required>
                                    @error('duration')
                                        <span class="text-danger" role="alert">
                                            <small>{{ $message }}</small>
                                        </span>
