    ...
    plugins: [
        laravel({
            input: [
                ...
                "resources/scss/pos-custom.scss",
                ...
                "resources/js/pages/customers-form.js",
                ...
                "resources/js/pages/notification-inbox.js",
                "resources/js/pages/pos.js",
                "resources/js/pages/provider-test-connection.js",
                "resources/js/pages/reports-appointments.js",
                "resources/js/pages/reports-customers.js",
                "resources/js/pages/reports-dashboard.js",
                "resources/js/pages/reports-expenses.js",
                "resources/js/pages/reports-inventory.js",
                "resources/js/pages/reports-sales.js",
                "resources/js/pages/settings.js",
                "resources/js/pages/staff-attendance.js",
                "resources/js/pages/template-preview.js",
                "resources/js/pages/broadcast-recipient-select.js",
            ],
            refresh: true,
        }),
    ],
            ...
            output: {
                manualChunks(id) {
                    if (id.includes('node_modules')) {
                        if (id.includes('chart.js') || id.includes('apex')) return 'vendor-charts';
                        if (id.includes('sweetalert2')) return 'vendor-ui';
                        if (id.includes('datatables')) return 'vendor-tables';
                        if (id.includes('bootstrap') || id.includes('jquery')) return 'vendor-core';
                        if (id.includes('quill') || id.includes('dropzone') || id.includes('flatpickr')) return 'vendor-ui';
